...
BEZEL_DEBOSS = 6 * LAYER_H_BEZEL  # every debossed feature on the front face. EXACTLY 6 layers at
                      ...
                      # ⚠️ 5 LAYERS (0.80) READ, AND JP STILL WANTED MORE. Verdict on the
                      # printed r2 (2026-08-01, #48): "it's good but go even deeper next time
                      # pls." So 6 layers, and 6 IS TERMINAL: it leaves 2.04mm over the glass
                      # against the >=2.00 assert below, so there is no 7th step — going deeper
                      # than 0.96 means revisiting the glass floor itself, which is a design
                      # conversation and not an edit to this constant (#48's own framing).
                      # THE FLOOR THIS LEAVES IS MEASURED, NOT ASSUMED. Ray-cast on a 0.4mm grid
                      # over the exported bezel (first done at 0.48 — 3899 of 3901 debossed
                      # sample points on exactly 2.520mm of web; re-run at 0.96 for #48,
